...
class UnetDecoder(Model):
    ...
    def __init__(
        ...
        if se_module:
            self.layer1 = DecoderBlockSE(in_channels[0], out_channels[0], use_batchnorm=use_batchnorm)
            self.layer2 = DecoderBlockSE(in_channels[1], out_channels[1], use_batchnorm=use_batchnorm)
            self.layer3 = DecoderBlockSE(in_channels[2], out_channels[2], use_batchnorm=use_batchnorm)
            self.layer4 = DecoderBlockSE(in_channels[3], out_channels[3], use_batchnorm=use_batchnorm)
            self.layer5 = DecoderBlockSE(in_channels[4], out_channels[4], use_batchnorm=use_batchnorm)
        else:
