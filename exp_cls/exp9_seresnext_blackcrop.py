# ===============
# best_ckpt=5, fold=0
# 2019-10-03 10:52:36,664 - INFO - Mean train loss: 0.03654
# 2019-10-03 10:53:31,711 - INFO - Mean valid loss: 0.04792
# 2019-10-03 10:54:26,618 - INFO - Mean EMA valid loss: 0.04271
# ===============
import os
import gc
import copy
...
def main(seed):
    ...
    with timer('preprocessing'):
        ...
        train_dataset = SeverCLSDataset(train_df, IMG_DIR, IMG_SIZE, N_CLASSES, y_train, id_colname=ID_COLUMNS,
                                    transforms=train_augmentation, crop_rate=1.0, p_black_crop=BLACK_CROP_RATE)
        val_dataset = SeverCLSDataset(val_df, IMG_DIR, IMG_SIZE, N_CLASSES, y_val, id_colname=ID_COLUMNS,
                                  transforms=val_augmentation, p_black_crop=BLACK_CROP_RATE)
