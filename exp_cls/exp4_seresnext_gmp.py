# ===============
# best_ckpt=3, fold=0
# 2019-09-25 04:49:04,618 - INFO - Mean train loss: 0.05065
# 2019-09-25 04:49:42,432 - INFO - Mean valid loss: 0.06236
# 2019-09-25 04:50:20,367 - INFO - Mean EMA valid loss: 0.04088
#  best_ckpt=2, fold=1
# 2019-09-25 12:03:14,552 - INFO - Mean train loss: 0.06665
# 2019-09-25 12:03:54,228 - INFO - Mean valid loss: 0.04997
# 2019-09-25 12:04:34,012 - INFO - Mean EMA valid loss: 0.04547
#  best_ckpt=2, fold=2
# 2019-09-26 02:53:10,417 - INFO - Mean train loss: 0.05515
# 2019-09-26 02:53:53,315 - INFO - Mean valid loss: 0.05678
# 2019-09-26 02:54:36,487 - INFO - Mean EMA valid loss: 0.04428
#  best_ckpt=4, fold=3
# 2019-09-26 07:03:30,408 - INFO - Mean train loss: 0.0534
# 2019-09-26 07:04:08,401 - INFO - Mean valid loss: 0.05829
# 2019-09-26 07:04:46,244 - INFO - Mean EMA valid loss: 0.03944
# ===============
import os
import gc
import copy
...
def main(seed):
    ...
    with timer('create model'):
        model = SEResNext(num_classes=N_CLASSES, pool_type="gem")
