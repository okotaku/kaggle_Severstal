...
EPOCHS = 35
FOLD_ID = 0
EXP_ID = "exp12_pspnet_seresnext101"
model_path = "../input/sev-exp12-pspnet-seresnext101-fold0-3/exp12_pspnet_seresnext101_fold0_ckpt5.pth"
...
def main():
    ...
    with timer('create model'):
        model = smp.PSPNet('se_resnext101_32x4d', encoder_weights='imagenet', classes=N_CLASSES, encoder_se_module=True)
