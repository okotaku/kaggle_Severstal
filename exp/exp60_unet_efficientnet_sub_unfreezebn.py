# ===============
# best_ckpt=5, fold=0
# 2019-09-24 22:58:56,557 - INFO - Mean train loss: 0.00962
# 2019-09-24 23:01:39,769 - INFO - Mean valid loss: 0.0089
# 2019-09-24 23:04:23,288 - INFO - Mean EMA valid loss: 0.00837
# ===============
import os
import gc
import copy
...
def main(seed):
    ...
    with timer('create model'):
        model = smp.Unet('efficientnet-b5', encoder_weights=None, classes=N_CLASSES, encoder_se_module=True,
                         decoder_semodule=True, h_columns=False, skip=True, act="swish", freeze_bn=False,
