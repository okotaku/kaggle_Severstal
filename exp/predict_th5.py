...
def predict(models, valid_loader, criterion, device, classification=False):
    test_loss = 0.0
    true_ans_list = []
    preds_cat = []
    cls = []
...
def main(seed):
    ...
    with timer('predict'):
        valid_loss, y_pred, y_true, cls = predict(models, val_loader, criterion, device, classification=CLASSIFICATION)
