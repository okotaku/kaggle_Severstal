# ===============
# best_ckpt=8, fold=0
# 2019-09-30 18:45:21,331 - INFO - Mean train loss: 0.01013
# 2019-09-30 18:47:25,895 - INFO - Mean valid loss: 0.00936
# 2019-09-30 18:47:25,896 - INFO - Mean valid score: 0.95103
# ===============
import os
import gc
import time
...
def main(seed):
    ...
    with timer('preprocessing'):
        ...
        train_dataset = SeverDataset(train_df, IMG_DIR, IMG_SIZE, N_CLASSES, id_colname=ID_COLUMNS,
                                    transforms=train_augmentation, crop_rate=1.0, class_y=y_train, meaning=True)
        val_dataset = SeverDataset(val_df, IMG_DIR, IMG_SIZE, N_CLASSES, id_colname=ID_COLUMNS,
                                  transforms=val_augmentation, meaning=True)
