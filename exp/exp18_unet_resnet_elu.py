# ===============
# best_ckpt=12
# 2019-09-10 00:27:35,454 - INFO - Mean train loss: 0.00723
# 2019-09-10 00:28:01,573 - INFO - Mean valid loss: 0.00844
# ===============
import os
import gc
import time
...
def main(seed):
    ...
    with timer('create model'):
        model = smp.Unet('resnet34', encoder_weights="imagenet", classes=N_CLASSES, encoder_se_module=True,
                         decoder_semodule=True, h_columns=False, skip=True, act="elu")
